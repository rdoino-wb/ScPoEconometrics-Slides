...
.center[
`r emo::ji("warning")` Data inconsistencies and Sample Imbalances
...
`r emo::ji("clipboard")` Checklist:
  ...
  - <b>Strings</b>: 
    - `stringr::str_squish()` removes unnecessary whitespaces 
    - `stri_trans_nfd(str_replace_all(decomposed, "[^\\x01-\\x7F]", ""))` remove non-ASCII characters
...
`r emo::ji("thinking_face")` What happens if we don't have a clear, consistent and unique key to match on?
...
#### Make Data Lake Great Again! `r emo::ji("cloud")`
...
.right-wide[
#### Why don't we just use <i>one for rule them all<i/>? 
]
--
.right-wide[
...
# Data Inconsistencies and Sample Imbalances `r emo::ji("warning")`
...
# Data Inconsistencies and Sample Imbalances
...
.right-wide[
`r emo::ji("pin")` Missing values refer to the absence of data in a dataset. They can arise for a variety of reasons, including: 
...
--
.right-wide[
`r emo::ji("white_check_mark")` How they look like:
  - `NA` a missing value is a missing value
]
--
.right-wide[
`r emo::ji("cross_mark")` How they <b>do not</b> look like:
  - `0` zero is a number
...
.right-wide[
`r emo::ji("pushpin")` An outlier is “an observation that deviates so much from other observations as to arouse suspicion that it was generated by a different mechanism” ([Hawkins 1980](https://api.semanticscholar.org/CorpusID:121985057))
]
...
.center[
<img src="../img/logo/plot1.png" width="420" height="460"/>
]
...
.center[
<img src="../img/logo/plot2.png" width="420" height="460"/>
]
...
.center[
<img src="../img/logo/plot3.png" width="420" height="460"/>
]
...
.right-wide[
`r emo::ji("toolbox")` Methods:
]
--
.right-wide[
- <b>Log-transformation</b>:
  - Stabilizes variance.
  - Can make outlier effects less pronounced.
  - Note: Only for positive-valued data.
- <b>Interquartile Range (IQR) Method</b>:
  - Arbitrary Multiplier
- <b>Trimming</b>:
  - Straightforward method but loses data.
- <b>Winsorizing</b>:
  - Retains all data points but limits extreme values.
]
--
.right-wide[
`r emo::ji("warning")` Use whatever, but <b><u>don't forge to report!</u></b>
]
...
.right-wide[
<i>How can we twist things even more?</i> `r emo::ji("thinking")`
]
--
.right-wide[
- <b>Balanced Panel</b>:
A balanced panel refers to a dataset in which every individual (or entity) is observed in every time period. There's no missing observation for any individual across the specified periods. 
]
--
.right-wide[
- <b>Unbalanced Panel</b>:
An unbalanced panel is a dataset where at least one individual (or entity) has missing observations for one or more time periods.
]
--
.right-wide[
`r emo::ji("warning")` <u>Don't forget that we usually have more levels!</u>
]
...
.center[
<img src="../img/logo/plot.png" width="700" height="500"/>
]
...
- Thiago Scot, Antoine Deeb, Maria Ruth Jones, and Tatiana Flores Ibarra for feedbacks.
- Professor Florian Oswald from whom I used a lot of [resources](https://raw.githack.com/floswald/lectures/master/05-datatable/05-datatable.html#1) especially for building the [presentation](https://github.com/ScPoEcon/ScPoEconometrics)
- Professor [Grant McDermott](https://grantmcdermott.com/)
- Blog [Emily Riederer](https://grantmcdermott.com/)
- [Silvia Canelón, Ph.D.](https://spcanelon.github.io/xaringan-basics-and-beyond/) helped also a lot for the presentation
...
.center[
<img src="../img/logo/last.jpeg" width="650px"/>
]
